...
bot.start((ctx) => ctx.reply(`Вітаю, ${ctx.message.from.first_name}! \n` +
    ...
    'Бережи себе!' +
    'Викликати його можна за допомогою команди /start, або ж інтерфейсу самого Telegram', Markup.keyboard([
...
bot.on('text', (ctx) =>{
    ctx.reply('Даний бот не відповідає на текстові повідомлення. \n' +
        'Взаємодія тільки через нижне меню. /start')
})
